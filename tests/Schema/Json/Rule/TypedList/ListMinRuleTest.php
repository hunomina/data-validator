...
class ListMinRuleTest extends TestCase
{
     ...
     */
    public function testListMinRule(array $schema, bool $success, ?JsonData $data = null): void
    {
        if (!$success) {
            try {
    ...
    {
        return [
            ['string' => ['type' => JsonRule::STRING_TYPE, 'list-min' => 1]],
            false
        ];
    }
    ...
    {
        return [
            ['character' => ['type' => JsonRule::CHAR_TYPE, 'list-min' => 1]],
            false
        ];
    }
    ...
    {
        return [
            ['number' => ['type' => JsonRule::NUMERIC_TYPE, 'list-min' => 1]],
            false
        ];
    }
    ...
    {
        return [
            ['integer' => ['type' => JsonRule::INTEGER_TYPE, 'list-min' => 1]],
            false
        ];
    }
    ...
    {
        return [
            ['float' => ['type' => JsonRule::FLOAT_TYPE, 'list-min' => 1]],
            false
        ];
    }
    ...
    {
        return [
            ['boolean' => ['type' => JsonRule::BOOLEAN_TYPE, 'list-min' => 1]],
            false
        ];
    }
    ...
    {
        return [
            ['string-list' => ['type' => JsonRule::STRING_LIST_TYPE, 'list-min' => 1]],
            true,
            new JsonData([
                'string-list' => ['ok']
            ])
    ...
    {
        return [
            ['character-list' => ['type' => JsonRule::CHAR_LIST_TYPE, 'list-min' => 1]],
            true,
            new JsonData([
                'character-list' => ['o', 'k']
            ])
    ...
    {
        return [
            ['numeric-list' => ['type' => JsonRule::NUMERIC_LIST_TYPE, 'list-min' => 1]],
            true,
            new JsonData([
                'numeric-list' => [1]
            ])
    ...
    {
        return [
            ['integer-list' => ['type' => JsonRule::INTEGER_LIST_TYPE, 'list-min' => 1]],
            true,
            new JsonData([
                'integer-list' => [1]
            ])
    ...
    {
        return [
            ['float-list' => ['type' => JsonRule::FLOAT_LIST_TYPE, 'list-min' => 1]],
            true,
            new JsonData([
                'float-list' => [1.0]
            ])
    ...
    {
        return [
            ['boolean-list' => ['type' => JsonRule::BOOLEAN_LIST_TYPE, 'list-min' => 1]],
            true,
            new JsonData([
                'boolean-list' => [true]
            ])
    ...
    public function testInvalidListMinRuleValueOnTypedList(): void
    {
        try {
            new JsonSchema([
                'string-list' => ['type' => JsonRule::STRING_LIST_TYPE, 'list-min' => -1]
            ...
            $this->assertEquals(InvalidRuleException::INVALID_LIST_MIN_RULE, $t->getCode());
        }
    }
}